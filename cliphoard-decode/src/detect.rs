...
//! Magic-byte based MIME type detection.
//!
//! Identifies common file types by inspecting their header bytes,
//! without relying on external libraries or file extensions.
